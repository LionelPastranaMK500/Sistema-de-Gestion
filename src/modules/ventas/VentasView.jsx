...
import { PermIdentityTwoToneIcon, CloseIcon, MenuIcon } from "@constants/iconsConstants"; 
import useVentaStore from "@stores/ventasStore";
import { componentsVentas } from "@constants/menuItemsConstants"; 

// IMPORTANTE: Importar los nuevos modales específicos
...
// Importar los modales "OTROS" existentes
...
  // NUEVOS: Estados de visibilidad para los modales específicos
...
  
  // NUEVO: Estado para el descuento global en porcentaje
  const [globalDiscount, setGlobalDiscount] = useState(0); 

  // Lógica para el menú "OTROS" (SE CONSERVA)
...
  // NUEVA FUNCIÓN: Manejar el cambio del input de descuento, limitando a 0-100
...
    }
    
    // CORRECCIÓN CLAVE: Mapeamos los productos agregados para aplicarles el cálculo final del descuento
    const p = {
      ruc: doc,
...
      fecha: fechaEmision,
      fechaVencimiento,
      total: totalGeneral // Usar el total final calculado por el hook
    };
    
...
        </div>
      </div>
      {/* ... (Botones de Placa, O. Compra, Observaciones, Otros) */}
...
      <PlacaModal visible={showPlacaModal} onHide={() => setShowPlacaModal(false)} />
      <OrdenCompraModal visible={showOrdenCompraModal} onHide={() => setShowOrdenCompraModal(false)} />
      <ObservacionesModal visible={showObservacionesModal} onHide={() => setShowObservacionesModal(false)} />
